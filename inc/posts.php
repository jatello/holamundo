...
function get_post( $post_id ){
    ...
    //tambiñen saneo las variables que no son string, los número exj con la función intval()
...
function insert_post ( $title, $excerpt, $content ){
    ...
    //con esta función me aseguro de sanear lo que me llega de los inputs del formulario antes de meterlo en la tabla de mi bbdd
